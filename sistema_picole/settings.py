"""
Django settings for sistema_picole project.
...
SECRET_KEY = 'django-insecure--g3x^1zgr3w#rbgt@yqn51pso_oj^wvnw+apo1jpp!z6au#d8*'
...
ROOT_URLCONF = 'sistema_picole.urls'
...
WSGI_APPLICATION = 'sistema_picole.wsgi.application'
